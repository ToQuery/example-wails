            ...
            <section>
                ...
                <div className={cn(dirClass)}>
                    <table className="w-full border-collapse">
                        <thead>
                            <tr className="bg-gray-100 dark:bg-gray-700">
                                <th className="border border-gray-300 dark:border-gray-600 px-4 py-2 text-left">XDG 目录</th>
                                <th className="border border-gray-300 dark:border-gray-600 px-4 py-2 text-left">路径</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <section>
                ...
                <div className={cn(dirClass)}>
                    <table className="w-full border-collapse">
                        <thead>
                            <tr className="bg-gray-100 dark:bg-gray-700">
                                <th className="border border-gray-300 dark:border-gray-600 px-4 py-2 text-left">XDG 目录列表</th>
                                <th className="border border-gray-300 dark:border-gray-600 px-4 py-2 text-left">路径</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td className="border border-gray-300 dark:border-gray-600 px-4 py-2">XDG ApplicationDirs</td>
            ...
            <section>
                ...
                <div className={cn(dirClass)}>
                    <table className="w-full border-collapse">
                        <thead>
                            <tr className="bg-gray-100 dark:bg-gray-700">
                                <th className="border border-gray-300 dark:border-gray-600 px-4 py-2 text-left">XDG 用户目录</th>
                                <th className="border border-gray-300 dark:border-gray-600 px-4 py-2 text-left">路径</th>
                            </tr>
                        </thead>
                        <tbody>

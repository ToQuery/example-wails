const enUS = {
    translation: {
        ...
        'page.setting.title': 'Application Settings',
        'page.setting.subtitle': 'Customize your application experience',
        'page.setting.app.title': 'Wails Application',
        'page.setting.app.subtitle': 'Built with Wails and React',
        'page.setting.current_version': 'Current Version',
        'page.setting.version_and_updates': 'Version and Updates',
        'page.setting.check_updates': 'Check for Updates',
        'page.setting.check_updates_desc': 'Check if a new version is available',
        'page.setting.checking_updates': 'Checking...',
        'page.setting.theme_settings': 'Theme Settings',
        'page.setting.dark_mode': 'Dark Mode',
        'page.setting.theme_switch_desc': 'Switch the display theme of the application',
        'page.setting.language_settings': 'Language Settings',
        'page.setting.interface_language': 'Interface Language',
        'page.setting.language_switch_desc': 'Select the display language of the application',
        'page.setting.about': 'About',
        'page.setting.about_description': 'This is a desktop application example built with Wails and React. Wails provides a simple way to build desktop applications using Go and Web technologies.',
        'page.setting.wails_website': 'Wails Website',
        'page.setting.documentation': 'Documentation',
        'page.setting.wails_example_app': 'Wails Example App',
        'page.setting.built_with_wails_react': 'Built with Wails and React',

const enUS = {
  translation: {
    ...
    'page.example.embed-exec-binary': 'Embed Exec Binary',
    'page.example.embed-file': 'Embed File',
    'page.example.open-application': 'Open Application',
    'page.example.open-browser': 'Open Browser',

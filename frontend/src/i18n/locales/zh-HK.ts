const zhHK = {
  translation: {
    ...
    'page.example.embed-exec-binary': '嵌入執行二進制文件',
    'page.example.embed-file': '嵌入文件',
    'page.example.open-application': '打開應用程序',
    'page.example.open-browser': '打開瀏覽器',
